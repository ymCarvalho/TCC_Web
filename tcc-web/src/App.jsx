...
function App() {
  ...
  const validadionRegister = yup.object().shape({
    ...
    password: yup.string().min(8, "A senha deve ter 8 caracteres").required("Senha obrigatória"),
  ...
  return (
    <div className="container">
      ...
      <h1>Login</h1>
      <Formik initialValues={{}} onSubmit={handleClickLogin} validationSchema={validadioLogin}>
      ...
      <h1>Cadastro</h1>
      <Formik initialValues={{}} onSubmit={handleClickRegister} validationSchema={validadionRegister}>
        <Form className="login-form">
          <div className="login-form-group">
            <Field name="email" className="field" placeHolder="Email" />
            <ErrorMessage component="span" name="email" className="error"/>
          ...
          <div className="password-form-group">
            <Field name="confirmPassword" className="field" placeHolder="Confirmar senha" />
            <ErrorMessage component="span" name="confirmPassword" className="error"/>
          </div>
